...
public class TestComponent extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        leftFlyWheelMotor = hardwareMap.get(DcMotor.class, "leftFlyWheel");
        ...
        //This is horrible code purely for testing a single device, do not UNDER ANY CIRCUMSTANCES use this for non-testing purposes
